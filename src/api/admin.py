...
from .models import db, Restaurant, Pay, User, Addresses, Category, Product, Allergens, Ingredients, Correlatives, Order, Order_Detail, Allergens_Users
...
def setup_admin(app):
    ...
    admin.add_view(ModelView(Correlatives, db.session))
