...
from .models import db, Allergens_Users, Restaurant, Pay, User, Addresses, Category, Product, Allergens, Ingredients, Order, Order_Detail, Allergens_Users
...
def setup_admin(app):
    ...
    admin.add_view(ModelView(Allergens_Users, db.session))
